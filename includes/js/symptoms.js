...
function template(element_name, title) {
    return `<div><label class="col-6 radioLabel">${title}:</label><div class="custom-control custom-radio custom-control-inline"><input type="radio" class="custom-control-input" value="Yes" id="${element_name}Yes" name="${element_name}"><label class="custom-control-label" for="${element_name}Yes">Yes</label></div><div class="custom-control custom-radio custom-control-inline"><input type="radio" class="custom-control-input" value="No" id="${element_name}No" name="${element_name}" checked><label class="custom-control-label" for="${element_name}No">No</label></div><div class="custom-control custom-control-inline" id="${element_name}Range" style="display: none;"><select class="form-control" name="${element_name}_s" id="${element_name}_s"><option value="0">None</option><option value="1">Low</option><option value="2">Medium</option><option value="3">High</option></select></div></div>`;
}
