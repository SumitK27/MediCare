        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist">
            <nav class="sb-sidenav accordion text-white text-left" id="sidenavAccordion">
                <div class="col-12 sb-sidenav-menu">
                    ...
                    <h5 class="col-12 font-weight-bold text-primary text-white" id="v-pills-tab" role="tablist"
                        aria-orientation="vertical">USERS</h5>
                    ...
                    <div class="col-12 nav flex-column nav-pills text-white" id="v-pills-tab" role="tablist"
                        ...
                        <a class="nav-link text-white" href="#v-pills-profile">
                            ...
                            <a class="nav-link active text-white mb-4" id="v-pills-profile-tab" data-toggle="pill"
                                href="#v-pills-profile" role="tab" aria-controls="v-pills-profile"
                                aria-selected="false"><i class="fa fa-user-circle mr-3"></i>Profile</a>

                            <a class="nav-link text-white mb-4" id="v-pills-patient-tab " data-toggle="pill"
                                href="#v-pills-patient" role="tab" aria-controls="v-pills-patient"
                                aria-selected="true"><i class="fa fa-user mr-3"></i>Patients</a>

                            <a class="nav-link text-white" id="v-pills-nurse-tab " data-toggle="pill"
                                href="#v-pills-nurse" role="tab" aria-controls="v-pills-nurse" aria-selected="true"><i
                                    class="fas fa-user-md mr-3"></i>Nurses</a>
                        </a>
                    </div>
                </div>
    ...
    <div class="col-10">
        <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="col-6">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="firstName"
                                                            ...
                                                            maxlength="25" value="<?php echo $userInfo['first_name'] ?>"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="lastName"
                                                            ...
                                                            maxlength="25" value="<?php echo $userInfo['last_name'] ?>"
                                                            required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email"
                                                    placeholder="Enter your Email Address" maxlength="25"
                                                    value="<?php echo $userInfo['email'] ?>" required>
                                            </div>
                                            <button type="submit" class="btn btn-primary col-12"
                                                name="updateInfo">Save</button>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="oldPw" name="oldPw"
                                                    placeholder="Enter your Old Password" maxlength="25">
                                            </div>
            ...
            <div class="tab-pane fade show" id="v-pills-patient" role="tabpanel" aria-labelledby="v-pills-patient-tab">
                <button class="btn btn-primary float-right" onclick="location.href='add-patient.php'"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope='row' class="text-center">
                                <a href='user-details.php?user_id=<?php echo $row['user_id'] ?>'><i
                                        class="fa fa-chevron-circle-down" aria-hidden="true"></i></a>
                            </th>
                            <th scope='row'>
                                <div class="row">
                                    <div class="col">
                                        <a href='edit.php?user_id=<?php echo $row["user_id"] ?>'><i
                                                class="fa fa-edit"></i></a>
                                    </div>
                                    <div class="col">
                                        <a href="delete.php?user_id=<?php echo $row["user_id"] ?>'"><i
            ...
            <div class="tab-pane fade" id="v-pills-nurse" role="tabpanel" aria-labelledby="v-pills-nurse-tab">
                <div class="col">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-nurse" role="tabpanel"
                            aria-labelledby="v-pills-nurse-tab">
                            <button class="btn btn-primary float-right" onclick="location.href='add-patient.php'"><i
                                    class="fa fa-user-plus"></i>Add user</button>
                            <br><br>
                            <?php
