                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="email" type="email" name="email" class="form-control" placeholder="Enter your email" value="<?php getInputValue("email") ?>" maxlength="25" required />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" name="mob-no" placeholder="Enter Mobile No." class="form-control" value="<?php getInputValue("mob-no") ?>" maxlength="25" required />
                                            </div>
                                        </div>
                                    </div>
